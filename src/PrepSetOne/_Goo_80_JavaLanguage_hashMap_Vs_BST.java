...
public class _Goo_80_JavaLanguage_hashMap_Vs_BST {
    ...
    When should we prefer BST over Hash Tables, what are advantages. */
    ...
    /*Following are some important points in favor of BSTs.*//**
        ...
        2. Doing order statistics, finding closest lower and greater elements, doing range queries are easy
        to do with BSTs. Like sorting, these operations are not a natural operation with Hash Tables.
