...
public class _Design_03_Implement_HashMap {
        ...
        public static void main(String[] args) {
                _Design_03_Implement_HashMap hashMap = new _Design_03_Implement_HashMap();
                hashMap.MyHashMap();
                hashMap.put(1, 101);
                hashMap.put(2, 202);
